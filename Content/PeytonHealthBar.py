...
class PeytonHealthBar:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        Player = self.Space.FindObjectByName("Peyton")
        ...
        if(Player):
            ...
            PlayerHealth = (Player.PeytonHealth.CurrentHealth / Player.PeytonHealth.MaxHealth)
...
Zero.RegisterComponent("PeytonHealthBar", PeytonHealthBar)