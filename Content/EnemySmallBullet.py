...
class EnemySmallBullet:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        if(self.Start == True):
            ...
            #Name
            self.Owner.Name = "EnemySmallBullet"
    ...
    def OnCollisionStarted(self, CollisionEvent):
        ...
        if(other.Name == "Tung" or other.Name == "Austin" or other.Name == "Trey" or other.Name == "Peyton" or other.Name == "Sedrick" or other.Name == "Julio"):
            ...
            self.Owner.Sprite.SpriteSource = "EnemyBulletHit"
...
Zero.RegisterComponent("EnemySmallBullet", EnemySmallBullet)