...
class GunManBodyShoot:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        if(self.CanShoot is True):
            self.Owner.Sprite.SpriteSource = "GunManBodyShoot"
            self.CanShoot = False
        elif(self.CanIdle is True):
            self.Owner.Sprite.SpriteSource = "GunManBody"
            self.CanIdle = False

Zero.RegisterComponent("GunManBodyShoot", GunManBodyShoot)