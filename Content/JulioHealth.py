    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        if(self.CurrentHealth <= 0):
            ...
            if(self.DeathSpawn == False):
                ...
                Body = self.Owner.FindChildByName("JulioBody")
                Weapon1 = self.Owner.FindChildByName("Sword1")
                
                PivotBody.RemoveComponentByName("JulioBody")
                Body.RemoveComponentByName("JulioBodyShoot")
                Weapon1.RemoveComponentByName("Sword1")
                Weapon1.RemoveComponentByName("Sword2")
                Weapon1.RemoveComponentByName("Sword3")
                
                self.Owner.RemoveComponentByName("JulioPlayerController")
                
                self.Owner.Sprite.SpriteSource = "JulioIdle"
                Body.Sprite.SpriteSource = "JulioBody"
...
Zero.RegisterComponent("JulioHealth", JulioHealth)