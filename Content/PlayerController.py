...
class PlayerController:
    def DefineProperties(self):
        ...
        self.MoveSpeed = Property.Float(25.0)
    ...
    def ApplyMovement(self, UpdateEvent):
        ...
        TungBody = self.Space.FindObjectByName("TungBody")
        ...
        if(self.CanWalk is True):
            self.Owner.Sprite.SpriteSource = "TungWalk"
            self.CanWalk = False
            
        if(self.CanWalkBackward is True):
            self.Owner.Sprite.SpriteSource = "TungWalkBack"
            self.CanWalkBackward = False
            
        elif(self.CanJump is True):
            self.Owner.Sprite.SpriteSource = "TungFall"
            self.CanJump = False
            ...
            self.Owner.Sprite.SpriteSource = "TungKneel"
            self.CanKneel = False
