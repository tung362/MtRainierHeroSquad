...
class PeytonPlayerController:
    def DefineProperties(self):
        self.OnGround = Property.Bool(False)
        
        self.MoveSpeed = Property.Float(15.0)
        self.JumpSpeed = Property.Float(15.0)
    ...
    def ApplyMovement(self, UpdateEvent):
        ...
        TungBody = self.Space.FindObjectByName("PeytonBody")
        ...
        if(self.CanWalk is True):
            self.Owner.Sprite.SpriteSource = "PeytonWalk"
            self.CanWalk = False
            
        if(self.CanWalkBackward is True):
            self.Owner.Sprite.SpriteSource = "PeytonWalkBack"
            self.CanWalkBackward = False
            
        elif(self.CanJump is True):
            self.Owner.Sprite.SpriteSource = "PeytonFall"
            self.CanJump = False
            ...
            self.Owner.Sprite.SpriteSource = "PeytonKneel"
            self.CanKneel = False
...
Zero.RegisterComponent("PeytonPlayerController", PeytonPlayerController)