...
class AustinHealthBar:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        Player = self.Space.FindObjectByName("Austin")
        ...
        if(Player):
            ...
            PlayerHealth = (Player.AustinHealth.CurrentHealth / Player.AustinHealth.MaxHealth)
...
Zero.RegisterComponent("AustinHealthBar", AustinHealthBar)