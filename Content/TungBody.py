...
class TungBody:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        elif(Zero.Keyboard.KeyIsDown(Zero.Keys.Space) or Parent.PlayerController.OnGround is False):
...
Zero.RegisterComponent("TungBody", TungBody)