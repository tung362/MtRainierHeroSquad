...
class JulioPlayerController:
    def DefineProperties(self):
        self.OnGround = Property.Bool(False)
        
        self.MoveSpeed = Property.Float(30.0)
        self.JumpSpeed = Property.Float(30.0)
    ...
    def ApplyMovement(self, UpdateEvent):
        ...
        TungBody = self.Space.FindObjectByName("JulioBody")
        ...
        if(self.CanWalk is True):
            self.Owner.Sprite.SpriteSource = "JulioWalk"
            self.CanWalk = False
            
        if(self.CanWalkBackward is True):
            self.Owner.Sprite.SpriteSource = "JulioWalkBack"
            self.CanWalkBackward = False
            
        elif(self.CanJump is True):
            self.Owner.Sprite.SpriteSource = "JulioFall"
            self.CanJump = False
            ...
            self.Owner.Sprite.SpriteSource = "JulioKneel"
            self.CanKneel = False
