...
class SedrickPlayerController:
    ...
    def ApplyMovement(self, UpdateEvent):
        ...
        TungBody = self.Space.FindObjectByName("SedrickBody")
        ...
        if(self.CanWalk is True):
            self.Owner.Sprite.SpriteSource = "SedrickWalk"
            self.CanWalk = False
            
        if(self.CanWalkBackward is True):
            self.Owner.Sprite.SpriteSource = "SedrickWalkBack"
            self.CanWalkBackward = False
            
        elif(self.CanJump is True):
            self.Owner.Sprite.SpriteSource = "SedrickFall"
            self.CanJump = False
            ...
            self.Owner.Sprite.SpriteSource = "SedrickKneel"
            self.CanKneel = False
...
Zero.RegisterComponent("SedrickPlayerController", SedrickPlayerController)