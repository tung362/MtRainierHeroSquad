    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        if(self.CurrentHealth <= 0):
            ...
            if(self.DeathSpawn == False):
                ...
                Body = self.Owner.FindChildByName("AustinBody")
                Weapon1 = self.Owner.FindChildByName("ShotGun1")
                
                PivotBody.RemoveComponentByName("AustinBody")
                Body.RemoveComponentByName("AustinBodyShoot")
                Weapon1.RemoveComponentByName("ShotGun1")
                
                self.Owner.RemoveComponentByName("AustinPlayerController")
                
                self.Owner.Sprite.SpriteSource = "AustinIdle"
                Body.Sprite.SpriteSource = "AustinBody"
...
Zero.RegisterComponent("AustinHealth", AustinHealth)