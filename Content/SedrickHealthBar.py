...
class SedrickHealthBar:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        Player = self.Space.FindObjectByName("Sedrick")
        ...
        if(Player):
            ...
            PlayerHealth = (Player.SedrickHealth.CurrentHealth / Player.SedrickHealth.MaxHealth)
...
Zero.RegisterComponent("SedrickHealthBar", SedrickHealthBar)