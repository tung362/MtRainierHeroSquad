...
class TreyHealthBar:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        Player = self.Space.FindObjectByName("Trey")
        ...
        if(Player):
            ...
            PlayerHealth = (Player.TreyHealth.CurrentHealth / Player.TreyHealth.MaxHealth)
...
Zero.RegisterComponent("TreyHealthBar", TreyHealthBar)