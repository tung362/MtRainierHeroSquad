...
class JulioHealthBar:
    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        Player = self.Space.FindObjectByName("Julio")
        ...
        if(Player):
            ...
            PlayerHealth = (Player.JulioHealth.CurrentHealth / Player.JulioHealth.MaxHealth)
...
Zero.RegisterComponent("JulioHealthBar", JulioHealthBar)