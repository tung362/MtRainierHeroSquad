    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        if(self.CurrentHealth <= 0):
            ...
            if(self.DeathSpawn == False):
                ...
                Body = self.Owner.FindChildByName("TreyBody")
                Weapon1 = self.Owner.FindChildByName("MissleGun1")
                
                PivotBody.RemoveComponentByName("TreyBody")
                Body.RemoveComponentByName("TreyBodyShoot")
                Weapon1.RemoveComponentByName("MissleGun1")
                
                self.Owner.RemoveComponentByName("TreyPlayerController")
                
                self.Owner.Sprite.SpriteSource = "TreyIdle"
                Body.Sprite.SpriteSource = "TreyBody"
...
Zero.RegisterComponent("TreyHealth", TreyHealth)