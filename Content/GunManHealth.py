    ...
    def OnLogicUpdate(self, UpdateEvent):
        ...
        if(self.CurrentHealth <= 0):
            ...
            if(self.DeathSpawn == False):
                ...
                Body = self.Owner.FindChildByName("GunManBody")
                Weapon1 = self.Owner.FindChildByName("Look")
                Weapon2 = self.Owner.FindChildByName("Pistol1")
                
                PivotBody.RemoveComponentByName("GunManBody")
                ...
                Weapon2.RemoveComponentByName("Pistol1")
                
                self.Owner.RemoveComponentByName("GunManController")
                
                self.Owner.Sprite.SpriteSource = "GunManIdle"
                Body.Sprite.SpriteSource = "GunManBody"
...
Zero.RegisterComponent("GunManHealth", GunManHealth)