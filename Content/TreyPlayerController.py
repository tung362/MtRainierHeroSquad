...
class TreyPlayerController:
    ...
    def ApplyMovement(self, UpdateEvent):
        ...
        TungBody = self.Space.FindObjectByName("TreyBody")
        ...
        if(self.CanWalk is True):
            self.Owner.Sprite.SpriteSource = "TreyWalk"
            self.CanWalk = False
            
        if(self.CanWalkBackward is True):
            self.Owner.Sprite.SpriteSource = "TreyWalkBack"
            self.CanWalkBackward = False
            
        elif(self.CanJump is True):
            self.Owner.Sprite.SpriteSource = "TreyFall"
            self.CanJump = False
            ...
            self.Owner.Sprite.SpriteSource = "TreyKneel"
            self.CanKneel = False
...
Zero.RegisterComponent("TreyPlayerController", TreyPlayerController)